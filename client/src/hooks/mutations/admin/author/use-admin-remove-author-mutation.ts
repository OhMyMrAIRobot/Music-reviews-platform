 ...
 *
 * Custom React hook returning a React Query mutation for removing an author.
 * On success it:
 ...
 * @returns The React Query mutation object for deleting an author.
 */
export const useAdminRemoveAuthorMutation = ({
  onSuccess,
  onError,
  onSettled,
}: UseMutationParams = {}) => {
