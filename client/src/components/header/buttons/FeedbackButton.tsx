...
const FeedbackButton = () => {
	...
	return (
		<div className='bg-primary rounded-md'>
			<button
				className='flex h-10 px-4 items-center justify-center rounded-md text-sm font-medium border border-white/20 cursor-pointer select-none transition-colors hover:bg-white/10!'
