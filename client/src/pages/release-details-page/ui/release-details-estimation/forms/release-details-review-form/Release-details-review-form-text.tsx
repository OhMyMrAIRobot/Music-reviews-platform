  ...
  return (
    ...
    >
      <input
        ...
        placeholder={t('releaseDetails.reviewForm.titlePlaceholder', {
          min: constraints.review.minTitleLength,
          max: constraints.review.maxTitleLength,
        })}
      ...
      <textarea
        ...
        maxLength={8500}
        placeholder={t('releaseDetails.reviewForm.textPlaceholder', {
          min: constraints.review.minTextLength,
          max: constraints.review.maxTextLength,
        })}
      ...
      <div className="flex sm:flex-row gap-y-2 flex-col-reverse w-full sm:justify-between">
        ...
        >
          ...
          <span>{t('releaseDetails.reviewForm.clearDraft')}</span>
        </button>
