import { ReleaseMediaStatus, ReleaseMediaType } from '@prisma/client';

/**
 * Normalized DTO representing a single release media entry returned to the client.
 */
export type ReleaseMediaDto = {
  /** Media record id */
  id: string;
...
/** Simple mapping that indicates a user favouriting a media item. */
type UserFavMedia = {
  mediaId: string;
  userId: string;
};
