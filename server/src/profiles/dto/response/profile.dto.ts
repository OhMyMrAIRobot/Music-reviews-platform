import { AuthorType, Role } from '@prisma/client';

/**
 * Profile DTO returned by profile-related endpoints.
 *
 * Includes account and profile metadata, social links and aggregated
 * statistics used for display on the public profile page.
 */
...
/**
 * Nested user account information included in `ProfileDto`.
 */
type User = {
